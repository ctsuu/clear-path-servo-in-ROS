// For RAMPS 1.4
#define X_DIR_PIN          9  // 55
#define X_STEP_PIN         10 //54
#define X_ENABLE_PIN       8  //38

#define Y_DIR_PIN          12 //61
#define Y_STEP_PIN         13 //60
#define Y_ENABLE_PIN       11 //56 
...
void loop() {
  ...
  for (int i = 0; i < NUM_STEPPERS; i++) {
    prepareMovement( i, 8000 );
    runAndWait();
  }

  for (int i = 0; i < NUM_STEPPERS; i++) {
    prepareMovement( i, 80000 );
    runAndWait();
  }
